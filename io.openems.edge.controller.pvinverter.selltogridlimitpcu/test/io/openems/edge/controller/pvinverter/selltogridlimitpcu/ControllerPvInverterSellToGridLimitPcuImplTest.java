...
import static io.openems.edge.controller.pvinverter.selltogridlimitpcu.ControllerPvInverterSellToGridLimitPcuImpl.DEFAULT_MAX_ADJUSTMENT_RATE;
...
public class ControllerPvInverterSellToGridLimitPcuImplTest {

	@Test
	public void symmetricMeterTest() throws Exception {
		new ControllerTest(new ControllerPvInverterSellToGridLimitPcuImpl()) //
